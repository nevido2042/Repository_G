...
// CImageViewerApp 사용자 지정 로드/저장 방법

void CImageViewerApp::PreLoadState()
{
	BOOL bNameValid;
	CString strName;
...
void CImageViewerApp::LoadCustomState()
{
}

void CImageViewerApp::SaveCustomState()
{
}
